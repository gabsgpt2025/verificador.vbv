  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          'focus-visible:border-ring focus-visible:ring-ring/50 flex flex-1 items-center justify-between gap-3 py-4 text-left text-sm font-medium outline-none transition-all hover:underline [&[data-state=open]>svg]:rotate-180 focus-visible:ring-[3px]',
          className,
        )}
        {...props}
      >
