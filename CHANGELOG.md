...
- Pipeline de pacotes padronizado em pnpm: removido `package-lock.json`; `package.json` agora declara `"packageManager": "pnpm@9.15.0"`; CI alinhada para pnpm 9.15.0 com `--frozen-lockfile`.
