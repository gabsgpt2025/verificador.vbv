...
const sampleAnalysis: FullBinAnalysis = {
  ...
  holistic: {
    ...
    peerComparison: { percentile: 88, description: "melhor que 88% dos cartões" },
    binRisk: { score: 10, weight: 0.3, factors: [], explanation: { technical: "t", popular: "p" }, dataAvailable: true },
    temporalRisk: { score: 10, weight: 0.1, factors: [], explanation: { technical: "t", popular: "p" }, dataAvailable: true },
    behavioralRisk: { score: 10, weight: 0.15, factors: [], explanation: { technical: "t", popular: "p" }, dataAvailable: true },
